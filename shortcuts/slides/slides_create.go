...
var SlidesCreate = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "slides", Desc: "slide content JSON array (each element is a <slide> XML string)"},
	},
	Validate: func(ctx context.Context, runtime *common.RuntimeContext) error {
		if slidesStr := runtime.Str("slides"); slidesStr != "" {
			...
			if len(slides) > maxSlidesPerCreate {
				return common.FlagErrorf("--slides array exceeds maximum of %d slides", maxSlidesPerCreate)
			}
		}
		return nil
	},
